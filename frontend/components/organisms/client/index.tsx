...
export const ClientListAll: React.FC<Props> = async ({ sectionTitle, data }) => {
        ...
        {rows.map((x, i) => (
          <ClientMarquee
            ...
            data={x.map(({ attributes }) => ({
              ...
              image: { light: getStrapiMedia(attributes.image), dark: getStrapiMedia(attributes.imageDark) },
...
export const ClientListByType: React.FC<Props> = async ({ sectionTitle, data }) => {
  return (
