...
import { GetPortfolioResponse } from "../api/portfolio.interface";

export const PortfolioDetail: React.FC<GetPortfolioResponse> = ({ data }) => {
  const { title, image, content, createdAt } = data;
